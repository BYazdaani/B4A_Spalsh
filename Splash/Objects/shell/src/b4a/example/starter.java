...
public static b4a.example.act_home _act_home = null;
  public Object[] GetGlobals() {
		return new Object[] {"act_Home",Debug.moduleToString(b4a.example.act_home.class),"Main",Debug.moduleToString(b4a.example.main.class),"Service",starter.mostCurrent._service};
}
}